...
| SD-005 |      | Functionaliteiten | ## Core features<br> - Taken aanmaken<br> - Taken wijzigen<br>- Taken verwijderen<br> - Gantt visualisatie<br> - Realtime updates<br> <hr> ## UI features<br>- Section grouping<br>- Status indicators<br>- Timeline view  | | Description | |   |   | 🟡 Medium  | 🔍 Review |
| SD-008 |      | KPI’s             | - Laadtijd < 2s<br>- Realtime latency < 500ms<br>- 99% uptime  |  | Description |  | |  | 🟡 Medium  | 🔍 Review |
...
|ID-003 | | Werkwijze iPad | iPad werkwijze:<br>1. Bestand aanpassen via claude.ai<br>2. Bestand downloaden<br>3. Bestand vervangen in clone map op computer<br>4. git add . + git commit -m "beschrijving" + git push<br><br>Computer werkwijze:<br>1. Claude Code for VS Code past bestanden direct aan<br>2. git add . + git commit -m "beschrijving" + git push | | Description | | | | 🔴 High | 🔍 Review |
